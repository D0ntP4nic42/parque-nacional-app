...
import 'saibamais1_edit_model.dart';
export 'saibamais1_edit_model.dart';

class Saibamais1EditWidget extends StatefulWidget {
  const Saibamais1EditWidget({super.key});

  @override
  State<Saibamais1EditWidget> createState() => _Saibamais1EditWidgetState();
}

class _Saibamais1EditWidgetState extends State<Saibamais1EditWidget> {
  late Saibamais1EditModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Saibamais1EditModel());
                              ...
                              child: TextFormField(
                                controller: _model.textController ??=
                                  ...
                                  text: valueOrDefault<String>(
                                    columnDadosGeraisRecord?.saibaMais1,
                                    'Sem texto!',
                                  ),
                                ),
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              await columnDadosGeraisRecord!.reference
                                ...
                                saibaMais1: _model.textController.text,
                              ));
                            },
                            text: 'Confirmar',
                            icon: Icon(
