...
import 'schema/turmas_record.dart';
import 'schema/dados_gerais_record.dart';
...
export 'schema/turmas_record.dart';
export 'schema/dados_gerais_record.dart';
...
/// Functions to query TurmasRecords (as a Stream and as a Future).
Future<int> queryTurmasRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      TurmasRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<TurmasRecord>> queryTurmasRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      TurmasRecord.collection,
      TurmasRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<TurmasRecord>> queryTurmasRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query DadosGeraisRecords (as a Stream and as a Future).
Future<int> queryDadosGeraisRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      DadosGeraisRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<DadosGeraisRecord>> queryDadosGeraisRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      DadosGeraisRecord.collection,
      DadosGeraisRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<DadosGeraisRecord>> queryDadosGeraisRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
