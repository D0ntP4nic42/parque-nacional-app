...
import 'adm_lista_educadores_model.dart';
export 'adm_lista_educadores_model.dart';

class AdmListaEducadoresWidget extends StatefulWidget {
  const AdmListaEducadoresWidget({
    super.key,
  ...
  @override
  State<AdmListaEducadoresWidget> createState() =>
      _AdmListaEducadoresWidgetState();
}

class _AdmListaEducadoresWidgetState extends State<AdmListaEducadoresWidget> {
  late AdmListaEducadoresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AdmListaEducadoresModel());
