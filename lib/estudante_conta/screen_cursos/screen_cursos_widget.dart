...
import 'screen_cursos_model.dart';
export 'screen_cursos_model.dart';

class ScreenCursosWidget extends StatefulWidget {
  const ScreenCursosWidget({super.key});

  @override
  State<ScreenCursosWidget> createState() => _ScreenCursosWidgetState();
}

class _ScreenCursosWidgetState extends State<ScreenCursosWidget> {
  late ScreenCursosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScreenCursosModel());
