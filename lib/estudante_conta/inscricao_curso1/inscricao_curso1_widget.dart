...
import 'inscricao_curso1_model.dart';
export 'inscricao_curso1_model.dart';

class InscricaoCurso1Widget extends StatefulWidget {
  const InscricaoCurso1Widget({super.key});

  @override
  State<InscricaoCurso1Widget> createState() => _InscricaoCurso1WidgetState();
}

class _InscricaoCurso1WidgetState extends State<InscricaoCurso1Widget> {
  late InscricaoCurso1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InscricaoCurso1Model());
                      ...
                      Padding(
                        ...
                        child: Text(
                          valueOrDefault<String>(
                            () {
                              if (_model.countControllerValue! < 2) {
                                return '20 alunos';
                              } else if (_model.countControllerValue == 2) {
                                return '40 alunos';
                              } else if (_model.countControllerValue == 3) {
                                return '60 alunos';
                              } else {
                                return '80 alunos';
                              }
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: SelecTurmaWidget(
                                      curso:
                                          'Curso de Educação Ambiental para Educadores',
                                      instituicao: _model.textController1.text,
                                      cidade: _model.textController2.text,
                                    ),
                                  ),
                                ),
                              );
